...
export const ServiceCardContent = [
    {
      ...
      description:"Creating interactive and user-friendly websites using technologies like HTML, Tailwind CSS, ReactJS, and Next.js to deliver an excellent user experience."
    ...
    },
    {
        ...
        description:"Ensuring websites look great and function seamlessly across all devices, from desktops to smartphones."
      ...
      },
      {
        ...
        title:"Web Design",
        description:"Designing modern and visually appealing websites that reflect the project's purpose and personality while ensuring intuitive navigation."
