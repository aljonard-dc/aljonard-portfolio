...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative bg-neptune-100 py-24 min-h-screen flex items-center"
    >
      <ParticlesBackground />
      <div className="container mx-auto">
        ...
        >
          ...
          <div className="text-center lg:text-start space-y-5">
            ...
            <h2 className="text-sm md:text-base text-neptune-700">
          ...
          <div className="place-self-center lg:place-self-end">
            <div className="flex flex-col items-center space-y-5">
              <div className="relative size-[280px] md:size-[300px] lg:size-[320px] xl:size-[400px]">
                <Image
